/* cliques_exchange_connector.h
   Ben Liang, 24 March 2015
   Copyright (c) 2014 Datacratic.  All rights reserved.
   
   Exchange Connector for Cliques Labs
*/
...
struct CliquesExchangeConnector : public OpenRTBExchangeConnector {
    CliquesExchangeConnector(ServiceBase& owner, std::string name);
    CliquesExchangeConnector(std::string name, std::shared_ptr<ServiceProxies> proxies);
    ...
    typedef CreativeConfiguration<CreativeInfo> CliquesCreativeConfiguration;
...
private:
    ...
    CliquesCreativeConfiguration creativeConfig;
};
